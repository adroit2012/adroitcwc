...
<head>
    ...
    <link href="<?php echo ViewHelper::url("assets/css/jquery-ui.min.css") ?>" rel="stylesheet">
    ...
    <script src="<?php echo ViewHelper::url("assets/js/jquery-ui.min.js") ?>" type="text/javascript"></script>
</head>
