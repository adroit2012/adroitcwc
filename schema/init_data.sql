...
--
-- Host: localhost
-- Generation Time: Jan 27, 2012 at 08:21 PM
...
INSERT INTO `categories_events` (`category_id`, `event_id`) VALUES
(2, 2),
(2, 1),
(1, 3),
(1, 2),
...
INSERT INTO `comments` (`comment_id`, `event_id`, `talk_id`, `user_id`, `body`, `rating`, `is_private`, `create_date`) VALUES
(1, NULL, 1, 1, 'Excellent session!', NULL, 0, '2012-01-23 20:01:53'),
(2, NULL, 1, 1, 'It did really open my eyes; as web developers we very often ignore the actual protocol that we''re sending stuff through. Understanding the underlying mechanics of HTTP is indeed really important and even though I was half asleep the talk did indeed have many valid points and was nicely presented.', NULL, 0, '2012-01-23 20:11:34'),
(4, NULL, 1, 1, 'Great talk! It''s very nice to listen the basics explained by a master. Specially some basics I even knew about, thought.', NULL, 0, '2012-01-23 20:36:27'),
(5, NULL, 1, 1, 'Although much of the talk was what you can see in Symfony2 caching documentation, but anyway it is a pleasure to hear Fabien live. Big todo to all of us, read the HTTP Specification.', NULL, 0, '2012-01-23 20:39:31');
